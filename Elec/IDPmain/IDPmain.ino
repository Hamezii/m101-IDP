...
void setDriveDir(String dir) { 
  ...
  if (dir == "Left") {leftMotorTarget = -180; rightMotorTarget = 180;}
  if (dir == "Right") {leftMotorTarget = 180; rightMotorTarget = -180;}
  if (dir == "SweepLeft") {leftMotorTarget = -120; rightMotorTarget = 180;}
  if (dir == "SweepRight") {leftMotorTarget = 180; rightMotorTarget = -120;}
}
...
void followLine(){
  ...
  else if(leftLineSensorVal() && !rightLineSensorVal()) setDriveDir("SweepLeft");
  else if(!leftLineSensorVal() && rightLineSensorVal()) setDriveDir("SweepRight");
}
